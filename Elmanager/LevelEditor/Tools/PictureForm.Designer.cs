...
namespace Elmanager.LevelEditor.Tools
{
    internal partial class PictureForm : FormMod
		...
		private void InitializeComponent()
            ...
            this.iterationsTextBox = new IntTextBox();
            this.minCoverTextBox = new NumericTextBox();
        ...
        private NumericTextBox minCoverTextBox;
        private IntTextBox iterationsTextBox;
