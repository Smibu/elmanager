...
namespace Elmanager
{
    internal static class GeometryUtils
    {
        ...
        internal static Geometry GetSelectedPolygonsAsMultiPolygon(this IEnumerable<Polygon> px)
        {
        ...
        internal static IEnumerable<Envelope> FindCovering(this Geometry g, IEnumerable<Envelope> rectangles,
