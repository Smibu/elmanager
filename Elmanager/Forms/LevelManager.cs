...
namespace Elmanager.Forms
{
    public partial class LevelManager : FormMod, IManagerGui
    {
        ...
        public LevelManager()
        {
            ...
            Utils.ConfigureColumns<Level>(levelList);
            Utils.ConfigureColumns<Top10EntrySingle>(singleTop10List, true);
            Utils.ConfigureColumns<Top10EntryMulti>(multiTop10List, true);
            if (Global.AppSettings.LevelManager.ShowTooltipInList)
            {
                TypedList.CellToolTipGetter = GetLevelToolTip;
                Utils.ConfigureTooltip(ObjectList.CellToolTip);
            }
        ...
        {
            return !Global.AppSettings.LevelManager.ConfirmDelete || Utils.Confirm("Delete the selected levels - are you sure?");
        }

        public void NotifyAboutModification()
        {
            Utils.ShowError("Some files changed!");
        }
        ...
        private void removeSelectedTimesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (Utils.Confirm("Delete the selected times - are you sure?"))
            {
        ...
        private void UpdateViewer(ReplayViewer v)
        {
            if (CurrentLevelHasReplays)
            {
        ...
        private void clearTop10ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (Utils.Confirm("Delete all times - are you sure?"))
            {
